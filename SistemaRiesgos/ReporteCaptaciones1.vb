...
Public Class ReporteCaptaciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaRiesgos.ReporteCaptaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ReporteCaptaciones1rpt_RUT() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporteCaptaciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteCaptaciones = New ReporteCaptaciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
